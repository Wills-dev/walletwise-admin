...
const ServiceLayout = ({
  ...
  return (
    <DashboardLayout title="Services" className="pt-0 pb-20">
      <div className=" h-10 w-full border-b border-[#EDEDED] dark:border-gray-700 top-14 right-0 fixed bg-white/65 dark:bg-gray-900/65 backdrop-blur-2xl">
        <Container>
      ...
      <div className="py-6">
        <h2 className="sm:text-3xl text-2xl font-semibold dark:text-gray-300">
          {title}
        </h2>
      </div>
