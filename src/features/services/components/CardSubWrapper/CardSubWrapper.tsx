...
import VirtualLayout from "../VirtualLayout/VirtualLayout";

const CardSubWrapper = ({ service }: { service: string }) => {
  const {
    setLimit,
    nextPage,
    prevPage,
  ...
  return (
    <VirtualLayout
      title={`${service.replace("-", " ")} Transactions`}
